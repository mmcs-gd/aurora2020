...
import HideAndSeek from "../src/ai/steerings/hide&seek"
...
let SteeringHideAndSeekScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.player = this.characterFactory.buildCharacter('aurora', 100, 300, {player: true});
        ...
        // Creating characters
        this.seeker = this.characterFactory.buildCharacter('blue', 600, 300, {Steering: new HideAndSeek(this, objects, this.player)});
		this.seeker.hide = true;
