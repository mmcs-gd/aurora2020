import {default as getMatrixRooms} from './matrix_rooms.js';
...
export default class RoomGenerator {
    ...
    generateRooms(countOfRooms) {
        const matrix = getMatrixRooms(this.width, this.height);
        ...
        this._settingWorld();
        return {"Ground" : this.groundLayer, "Stuff" : this.stuffLayer, "Outside" : this.outsideLayer}
    }
